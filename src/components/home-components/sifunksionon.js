...
const Sifunksionon = () => {
  const siFunksiononItems = [
    {
      id: 0,
      icon: <BiAddToQueue className={"sifunksionon-icon"} />,
      title: "JEP PUNE",
      text:
        "Posto punë, pa pagesë. " +
        "Ju automatikisht do të ekspozoheni në kategorinë e duhur," +
        " ku kandidatët që kanë interesim do të kenë mundësinë të aplikojn.!",
    },
    {
      id: 1,
      icon: <BsSearch className={"sifunksionon-icon"} />,
      title: "ZGJEDH KANDIDATIN",
      text:
        "Shfletoni gjitha aplikimet," +
        " Bisedoni në kohë-reale me kandidatët," +
        " Krahasoni kandidatët dhe Zgjedhni më të mirin",
    },
    {
      id: 2,
      icon: <FaUserFriends className={"sifunksionon-icon"} />,
      title: "PAGUAJ SHËRBIMIN",
      text:
        "Sapo të finalizohet projekti " +
